...
# here (rack_chain), then SecurityHeaders and RateLimit, two independent
# middlewares. None reference each other, so order between them doesn't
# matter -- kept in the same order as the original single-file layout
# for the first two.
