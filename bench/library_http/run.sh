...
require "$lib_dir/lib/views/.cache/author_books_table.html"
require "$lib_dir/lib/views/.cache/author_show.html"
require "$lib_dir/lib/views/.cache/authors_table.html"
require "$lib_dir/lib/views/.cache/books_table.html"
require "$lib_dir/lib/views/.cache/book_show.html"
require "$lib_dir/lib/views/.cache/author_form.html"
require "$lib_dir/lib/views/.cache/book_form.html"
require "$lib_dir/lib/views/.cache/home.html"
require "$lib_dir/lib/views/.cache/layout.html"

require "$lib_dir/lib/database"
require "$lib_dir/lib/models/author"
require "$lib_dir/lib/models/book"

require "$lib_dir/lib/controllers/authors_controller"
require "$lib_dir/lib/controllers/books_controller"
