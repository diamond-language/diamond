...
def run_tests()
  ...
  def test_compound_result_can_be_paginated()
    ...
    base = Arel.union_all(left, right)
    query = base.take(10).skip(20)
    ...
    sql, params = base.to_sql()
    Minitest.assert_equal("SELECT \"first_values\".\"id\" FROM \"first_values\" UNION ALL SELECT \"second_values\".\"id\" FROM \"second_values\"", sql)
