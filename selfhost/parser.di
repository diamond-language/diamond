...
module Opcode
  ...
  # including CASE_MATCH/CASE_ARRAY_SHAPE/ARRAY_REST, do not shift this
...
class Parser
  ...
  # own emit_function_index -- the dynamically sized native function table
  # uses 16-bit indices, past what a single byte holds.
